...
try:
    ...
    args = {"owner": "Robin", "start_date": datetime(2017, 1, 1), "retries": 0, "retry_delay": timedelta(minutes=5), "pool": "occupeye_pool"}
    ...
    surveys_to_s3 = KubernetesPodOperator(
        namespace="airflow",
        image="robinlinacre/airflow-occupeye-scraper:v6",
        cmds=["bash", "-c"],
